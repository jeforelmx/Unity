...
public class Item : MonoBehaviour
{
    ...
    public void Use( int charToUseOn)
    {
        ...
        if (raiseExp)
        {
            selectedChar.AddExp(amountToChange);
        ...
        if (isletter)
        {
            GameMenu.instance.letterContent.text = "";
            GameMenu.instance.letterContent.text = letterContent.text;
            LetterPanel letterPanel = GameMenu.instance.letterPanel.GetComponent<LetterPanel>();
            letterPanel.OnItemSelected();
            GameMenu.instance.letterPanel.SetActive(true);
